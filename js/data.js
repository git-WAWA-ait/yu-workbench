...
// 考试成绩样例数据生成（演示用）。查询校验改用「姓名 + 私密查询码」，
// 查询码为随机令牌（不可由身份证号推导、不可枚举），替代原「身份证后6位」弱校验。
const SUBMAX = { 语文:120, 数学:120, 英语:120, 物理:100, 道法:50, 历史:50, 体育:60 };
function buildExamScores(){
  const base = [
    { name:"李梓涵", code:"LZ7Q2K9P", s:{语文:113,数学:118,英语:116,物理:95,道法:48,历史:49,体育:60} },
    { name:"王思远", code:"W2S8X4MD", s:{语文:108,数学:109,英语:110,物理:88,道法:45,历史:46,体育:58} },
    { name:"陈雨桐", code:"CY5T1R3B", s:{语文:110,数学:112,英语:108,物理:92,道法:47,历史:48,体育:59} },
    { name:"赵欣怡", code:"ZX9Y6N2V", s:{语文:105,数学:104,英语:106,物理:85,道法:44,历史:45,体育:57} },
    { name:"周子涵", code:"ZK4H8L7C", s:{语文:95,数学:100,英语:94,物理:80,道法:40,历史:42,体育:55} },
    { name:"钱多多", code:"QD3W1E6F", s:{语文:90,数学:96,英语:88,物理:78,道法:39,历史:41,体育:53} },
    { name:"张子轩", code:"ZX5C9B2N", s:{语文:92,数学:98,英语:90,物理:75,道法:38,历史:40,体育:54} },
    { name:"刘昊然", code:"LH7A4S8T", s:{语文:88,数学:85,英语:82,物理:70,道法:35,历史:37,体育:52} },
  ];
  const adj = {
    monthly:{},
  ...
  const mk = (name,date,delta)=>({ name, date, rows: base.map(st=>{
    ...
    return { name:st.name, code:st.code, s };
  }) });
  return {
